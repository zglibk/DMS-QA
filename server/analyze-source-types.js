...
async function analyzeSourceTypes() {
    try {
        ...
        console.log(`时间范围: ${complaint.EarliestRecord} - ${complaint.LatestRecord}`);
        ...
        try {
            ...
            console.log(`时间范围: ${rework.EarliestRecord} - ${rework.LatestRecord}`);
        } catch (error) {
        ...
        try {
            ...
            console.log(`时间范围: ${exception.EarliestRecord} - ${exception.LatestRecord}`);
        } catch (error) {
