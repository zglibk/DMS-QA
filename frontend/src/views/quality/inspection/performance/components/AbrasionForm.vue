<template>
  <div class="abrasion-form">
    <el-form :model="localData" label-width="100px" size="small" :disabled="readonly">
      <el-row :gutter="20">
        <el-col :span="12">
          <el-form-item label="荷重">
            <el-input v-model="localData.Conditions.Load" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
        ...
        <el-col :span="24">
            <el-form-item label="结果判断">
                <el-radio-group v-model="localData.Result">
...
watch(() => props.inspectionItems, (items) => {
    if (items && items.length > 0 && !localData.value.Standard) {
        const match = items.find(i => i.ItemName.includes('耐磨') || i.ItemName.includes('Abrasion'))
