...
/**
 * 窗口尺寸变化处理函数
 * 作用：在浏览器窗口尺寸变动时更新 windowWidth，从而触发 sidebarWidth 重新计算
 */
const handleResize = () => {
...
@media (max-width: 600px) {
 ...
 /* —— 菜单图标与高亮统一恢复 —— */
 /* 默认状态图标为白色（含 Element Plus el-icon 与 Iconify 图标） */
 .el-menu-vertical-demo :deep(.el-menu-item .el-icon),
 .el-menu-vertical-demo :deep(.el-sub-menu__title .el-icon),
 .el-menu-vertical-demo :deep(.el-menu-item .iconify),
 .el-menu-vertical-demo :deep(.el-sub-menu__title .iconify) {
   color: #fff !important;
   fill: #fff !important;
 }
 ...
 .el-menu-vertical-demo :deep(.el-menu-item:hover .iconify),
 .el-menu-vertical-demo :deep(.el-sub-menu__title:hover .iconify) {
   color: #fff !important;
   fill: #fff !important;
 }
 ...
 .el-menu-vertical-demo :deep(.el-menu-item.is-active .iconify),
 .el-menu-vertical-demo :deep(.el-sub-menu.is-active > .el-sub-menu__title .iconify) {
   color: #fff !important;
   fill: #fff !important;
 }
