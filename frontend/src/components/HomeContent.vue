...
<template>
  <div class="home-content-wrapper">
    <div class="home-content">
      ...
      <!-- 高级查询卡片 -->
      <div class="advanced-query-section" v-show="showAdvancedQuery">
          ...
          <el-form :model="advancedQuery" label-width="70px" class="advanced-form">
            ...
            <el-form-item label="不良率">
              <div class="rate-range">
                ...
                />
                <span style="margin: 0 8px; color: #909399; flex-shrink: 0;">-</span>
                <el-input-number
                  ...
                  style="width: 90px; flex-shrink: 0;"
                />
                <span style="margin-left: 4px; color: #909399; font-size: 12px; flex-shrink: 0;">%</span>
              </div>
            </el-form-item>
...
const showAdvancedQuery = ref(false) // 控制高级查询卡片显示/隐藏
...
.table-container {
  margin-right: 0; /* 移除右边距，因为高级查询卡片已移至上方 */
}
.table-card {
  background: #fff;
  border-radius: 0.5rem;
